# SSOT: ミエルボード for 現場 / 現場WEEK

**プロジェクト**: ミエルボード for 現場  
**第1弾モジュール**: 現場WEEK（Genba WEEK）  
**バージョン**: v2.0  
**最終更新**: 2025-12-07
...
このドキュメントは **「ミエルボード for 現場 / 現場WEEK」の設計における唯一の正（Single Source of Truth）** です。
...
| **現場WEEK** | 週間スケジュールボードモジュール | Phase 0 の主力機能 |
